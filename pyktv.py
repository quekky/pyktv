...
if __name__ == '__main__':
    ...
    # playlist.addVideo({"display":"test","url":"https://www.youtube.com/watch?v=vMCqvEPBGlA"})
    # playlist.addVideo({'channel': 'R', 'library': 'Z:\\KTV\\Videos\\流行歌曲','media_file': '\\0.其他\\羅嘉良 + 吳鎮宇 + 張可頤 + 宣萱 - 難兄難弟 [KTV].mp4', 'remark': '羅嘉良 + 吳鎮宇 + 張可頤 + 宣萱', 'display': '難兄難弟 《羅嘉良,吳鎮宇,張可頤,宣萱》  （粵,合唱）'})
